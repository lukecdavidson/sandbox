...
Process
{
	...
	#$xml.Configuration.LogonCommand.Command = 'powershell.exe -command "''&'' {Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope LocalMachine -Confirm:$False}"; powershell.exe $RunPSSCript'
